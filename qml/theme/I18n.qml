...
QtObject {
    ...
    readonly property var translations: ({
        "en": {
            ...
            "footer_security": "Omarchy Linux Security Standards (AGENTS.md) • White Hat Defensive Radar",
            "copied": "copied",
        ...
        "tr": {
            ...
            "footer_security": "Omarchy Linux Güvenlik Standartları (AGENTS.md) • Beyaz Şapka Savunmacı Radar",
            "copied": "kopyalandı",
